...
Java_com_example_glestest_render_nativeSurfaceCreate(
        JNIEnv *env,
        jclass type) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_glestest_render_nativeSurfaceChange(
        JNIEnv *env,
        jclass type,
        jint width,
        jint height) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_glestest_render_nativeDrawFrame(
        JNIEnv *env,
        jclass type) {
